...
function HeroText() {
  ...
  return (
    <div className="herotext-div">
        ...
        <Fade in={true} timeout={6500}><img className="hero-letsrock" src="https://i.imgur.com/xd7SOG7.png" alt="hero-letsrock"></img></Fade>
        <Fade in={true} timeout={6500}><img className="hero-slash" src="https://i.imgur.com/YzATa3o.png" alt="hero-slash"></img></Fade>
        </div>
